...
#  print(mapping_likelihoods)
  ...
  sigma2_t2 = .00001 #2*torch.sigmoid(init_parameters["sigma2_t2"]) #maybe change 2 for 4?
...
# Part: Initialize the model
  ...
  init_parameters["sigma2_t"] = MakeZeros(1) - 5
