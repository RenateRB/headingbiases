...
#  print(mapping_likelihoods)
  ...
  transform_FI = torch.softmax((10+init_parameters["f_t"][0])*SQUARED_STIMULUS_SIMILARITY(grid-180), dim=0).detach() #init_parameters["f_t"]
...
# Part: Initialize the model
  ...
  init_parameters["sigma2_t2"] = MakeZeros(1) -10
