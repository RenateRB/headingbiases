...
#  print(mapping_likelihoods)
  ...
  bayesianEstimateSecond = MAPCircularEstimator.apply(grid_indices_here, posterior_second)
...
#  init_parameters["SIGMA_priorByCO"] = MakeZeros(N_CO,2*FOURIER_BASIS_SIZE)
  ...
  loadParameters(init_parameters, f"logs/CROSSVALID/RunReisenegger_FreePrior_DifFreeResources_byCentralOrientation_Simplified_Shift_Co0_Prior_SepEnc_Debug_L0.py_{P_perc}_0_{REG_WEIGHT}_180.txt")
